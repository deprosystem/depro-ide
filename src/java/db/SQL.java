...
//    public static String getUserToken = "SELECT * FROM users WHERE user_id = SELECT user_id FROM token_user WHERE token=";
    ...
    public static String getProject = "SELECT project_name, project_id, app_name, package, project_comment, logo, host, where_server, date_create, image FROM projects WHERE user_id=";
