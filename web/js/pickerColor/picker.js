var picker = {
    ...
    init: function (cBack, element) {
        picker.callBack = cBack;
...
var Line ={
    ...
    init: function (elem){
        ...
        Line.posit = function (e){
            ...
            picker.callBack("rgb("+convert.hsv_rgb(t, picker.S, picker.V)+")");
        }
...
var Block = {
    ...
    init: function (elem) {
        ...
        Block.cPos = function (e){
            ...
            picker.callBack("rgb("+convert.hsv_rgb(Line.Hue, S, V)+")");
...
function convert16(conv) {
    var r = conv[0].toString(16);
    if (r.length == 1) {
        r = '0' + r;
    }
    var g = conv[1].toString(16);
    if (g.length == 1) {
        g = '0' + g;
    }
    var b = conv[2].toString(16);
    if (b.length == 1) {
        b = '0' + b;
    }
    return r + g + b;
