function uxScrollForm() {
    this.param = {name: "ScrollForm", viewBaseId: "scroll_form", onlyOne: true};
    ...
    this.addComponent = function (componId, viewId) {
        ...
        let typeViewScroll = {type:"ItemScroll",typeFull:{name:"ItemScroll",typeBlock:2},typeUxUi: "ui",gravLayout:{h:4,v:4},componParam:{st_1:""},
            gravity:{h:4,v:4},width: -1,height:-1,children:[],hideParam:62};
        let typeView = {type:"RelativeLayout",typeFull:{name:"RelativeLayout",typeBlock:0},typeUxUi: "ui",gravLayout:{h:4,v:4},gravity:{h:4,v:4},width: -1,height:-1,children:[typeViewScroll],hideParam:63};
