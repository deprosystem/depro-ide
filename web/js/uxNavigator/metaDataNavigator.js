...
var listMetaHandlers = [
        ...
        {handl:"send", meta:[{name: "param", title:"Model",type:"Send"},
                    {name: "after", title:"After",type:"Navig",after:true}]},
        {handl:"sign in", meta:[    //  {name: "param", title:"Model",type:"Send"},
                    {name: "param_1", title:"Text error Incorrect login or password",len:150,type:"Text"},
                    {name: "after", title:"After",type:"Navig",after:true}]},
        {handl:"sign up", meta:[{name: "param", title:"Model",type:"Send"},
                    {name: "after", title:"After",type:"Navig",after:true}]},
        {handl:"edit profile", meta:[{name: "param", title:"Model",type:"Send"},
                    {name: "after", title:"After",type:"Navig",after:true}]},
